...
![](images/multi-level-cache-05.png)
...
![](images/multi-level-cache-06.png)

请求地址是localhost，端口是80，就被windows上安装的Nginx服务给接收到了。然后代理给了OpenResty集群：

![](images/multi-level-cache-07.png)
...
![](images/multi-level-cache-08.png)
...
![](images/multi-level-cache-09.png)
...
![](images/multi-level-cache-10.png)
...
![](images/multi-level-cache-11.png)

### 4.查询Tomcat

拿到商品ID后，本应去缓存中查询商品信息，不过目前我们还未建立nginx、redis缓存。因此，这里我们先根据商品id去tomcat查询商品信息。我们实现如图部分：

![](images/multi-level-cache-12.png)

需要注意的是，我们的OpenResty是在虚拟机，Tomcat是在Windows电脑上。两者IP一定不要搞错了。

![](images/multi-level-cache-13.png)
...
![](images/multi-level-cache-14.png)
...
![](images/multi-level-cache-15.png)
...
![](images/multi-level-cache-16.png)
...
![](images/multi-level-cache-17.png)
...
![](images/multi-level-cache-18.png)
...
![](images/multi-level-cache-19.png)
...
![](images/multi-level-cache-20.png)
...
![](images/multi-level-cache-21.png)

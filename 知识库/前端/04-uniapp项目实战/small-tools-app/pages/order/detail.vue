<template>
	<view class="app-container" v-if="orderObj">
		...
		<view class="base-box">
			...
			<uni-list-item title="总金额" :rightText="orderObj.totalPrice" />
			<uni-list-item title="支付金额" :rightText="orderObj.payPrice" />
			<!-- <uni-list-item title="取餐时间" :rightText="orderObj.orderRemark" /> -->

...
模块化 [src/directive/index.js](../src/directive/index.js)
...
按钮权限指令 [src/directive/v-has-perm.js](../src/directive/v-has-perm.js)
...
角色权限指令 [src/directive/v-has-role.js](../src/directive/v-has-role.js)
